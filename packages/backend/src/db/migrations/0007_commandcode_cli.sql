...
CREATE TABLE IF NOT EXISTS sessions_next (
  ...
  cli TEXT NOT NULL CHECK(cli IN ('claude', 'opencode', 'codex', 'gemini', 'kimi', 'aider', 'qwen', 'antigravity', 'commandcode')),
  ...
  duration_ms INTEGER,
  total_cost_usd REAL,
  cost_source TEXT NOT NULL DEFAULT 'unknown' CHECK(cost_source IN ('actual', 'estimated', 'unknown')),
