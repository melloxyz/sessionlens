...
const dictionaries = {
  en: {
    ...
    'changelog.latest.1.text': 'Background auto-ingestion with local filesystem watcher',
    'changelog.latest.2.text': 'Real analytics filters across report, charts and breakdowns',
    'changelog.latest.3.text': 'OpenRouter pricing sync with estimated cost backfill',
  ...
  'pt-BR': {
    ...
    'changelog.pricing': 'Pricing',
    'changelog.localFirst': 'Local-first',
    'changelog.latest.1.text': 'Auto-ingestão em background com watcher de filesystem local',
    'changelog.latest.2.text': 'Filtros reais de analytics para relatório, gráficos e breakdowns',
    'changelog.latest.3.text': 'Sync de preços OpenRouter com backfill de custo estimado',
