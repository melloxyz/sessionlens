...
const dictionaries = {
  en: {
    ...
    'changelog.inProgress.1': 'More robust adapter validation across local AI coding CLIs',
    'changelog.inProgress.2': 'Better explainability for estimated cost calculations',
    'changelog.inProgress.3': 'Restore hidden projects controls',
    'changelog.planned.1': 'Local budget limits and alerts',
    'changelog.planned.2': 'System tray integration',
    'changelog.planned.3': 'Optional Electron runtime',
  ...
  'pt-BR': {
    ...
    'changelog.inProgress.1': 'Validação mais robusta de adapters das AI coding CLIs locais',
    'changelog.inProgress.2': 'Mais clareza para explicar cálculos de custo estimado',
    'changelog.inProgress.3': 'Restaurar controles de projetos ocultos',
    'changelog.planned.1': 'Limites e alertas de orçamento local',
    'changelog.planned.2': 'Integração com system tray',
    'changelog.planned.3': 'Runtime Electron opcional',
