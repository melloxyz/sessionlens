...
const dictionaries = {
  en: {
    ...
    'settings.appearance.description': 'Choose how AIMeter looks on this machine.',
    ...
    'settings.privacy.description': 'AIMeter reads local CLI state and keeps the product offline-first.',
  ...
  'pt-BR': {
    ...
    'settings.appearance.description': 'Escolha como o AIMeter aparece nesta máquina.',
    ...
    'settings.privacy.description': 'O AIMeter lê estado local das CLIs e mantém o produto offline-first.',
