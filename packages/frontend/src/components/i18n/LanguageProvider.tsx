...
const dictionaries = {
  en: {
    ...
    'changelog.contributors.description': 'People who helped build Sessionless',
    ...
    'changelog.released.1.title': 'Sessionless foundation',
    'changelog.released.1.1': 'Sessionless branding and package rename',
    ...
    'settings.tray.description': 'Keep Sessionless running in the system tray for quick access.',
    'settings.tray.enable': 'Enable system tray',
    'settings.tray.enable.description':
      'Show Sessionless icon in the notification area. Requires restart.',
    'settings.tray.autoStart': 'Start with system',
    'settings.tray.autoStart.description': 'Launch Sessionless when you log in.',
    ...
    'settings.tray.restartNote': 'Restart Sessionless for tray changes to take effect.',
  ...
  'pt-BR': {
    ...
    'changelog.contributors.description': 'Pessoas que ajudaram a construir o Sessionless',
    ...
    'changelog.released.1.version': 'v0.7.0',
    'changelog.released.1.title': 'Fundação Sessionless',
    'changelog.released.1.1': 'Marca Sessionless e renomeação de pacotes',
    ...
    'settings.tray.description': 'Mantenha o Sessionless rodando na bandeja para acesso rápido.',
    'settings.tray.enable': 'Ativar bandeja do sistema',
    'settings.tray.enable.description':
      'Mostrar ícone do Sessionless na área de notificação. Requer reinício.',
    'settings.tray.autoStart': 'Iniciar com o sistema',
    'settings.tray.autoStart.description': 'Abrir o Sessionless ao fazer login.',
    'settings.tray.startMinimized': 'Iniciar minimizado',
    'settings.tray.startMinimized.description': 'Não abrir o dashboard ao iniciar.',
    'settings.tray.restartNote': 'Reinicie o Sessionless para aplicar as mudanças na bandeja.',
